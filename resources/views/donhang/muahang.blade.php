@extends('layouts.app')
<link rel="stylesheet" href="{{ asset('public/css/muahanggh.css') }}">
...
<div class="checkout-container">
    ...
    <div class="checkout-left">
        ...
        <form action="{{ route('donhang.datGioHang') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="email" name="email_nguoi_nhan" id="email_nguoi_nhan"
                    class="form-control"
                    value="{{ old('email_nguoi_nhan', Auth::user()->email ?? '') }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="dia_chi_giao" id="dia_chi_giao"
                    class="form-control"
                    value="{{ old('dia_chi_giao', Auth::user()->dia_chi ?? '') }}" required>
            </div>

            <h1><span class="so2">2</span> Phương thức thanh toán</h1>
    ...
    <div class="order-summary">
        ...
        <div class="summary-images">
            ...
            @endphp
            <img src="{{ asset('public/storage/' . ltrim($firstImage, '/')) }}" alt="">
            @endforeach
        </div>
        ...
        <div class="order-detail">
            ...
            <div class="order-line">
                ...
                <span class="pvc">Tính khi giao hàng</span>
            </div>
            ...
            <div class="order-line total">
                ...
                <strong class="tong">{{ number_format($tongCuoi, 0, ',', '.') }}₫</strong>
            </div>
        </div>
    </div>
